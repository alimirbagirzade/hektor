...
- **Şablon tekrarı** (v8 dersi, 2026-09-14) → aynı 8-kelimelik ifade cevapların %2'sinden
  ...
  v8'in eğitim setinde 31 ifade bu eşiği aşıyordu (eval'de ~%19 tekrar); sağlıklı sentetik
  veride 0. Açılış kuralı cevabın BAŞINI görür; bu kural cevabın herhangi bir yerini.
